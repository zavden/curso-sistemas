...
\title{%
  ...
  \large Linux $\cdot$ C $\cdot$ Rust
}
\author{21 bloques --- B01 a B21}
\date{}
...
Para roles de SysAdmin, DevOps, o SRE. Cubre scripting, bases de datos,
cloud (AWS + Terraform), Kubernetes, y observabilidad. B01 (Docker)
recomendado en paralelo con B09.
