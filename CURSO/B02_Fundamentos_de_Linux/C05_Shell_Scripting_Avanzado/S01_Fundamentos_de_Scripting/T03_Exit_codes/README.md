...
| 2 | Uso incorrecto del comando (argumentos inválidos) |
| 126 | Comando encontrado pero no ejecutable (sin permiso) |
| 127 | Comando no encontrado |
| 128 | Argumento inválido para exit |
| 128+N | Terminado por señal N (ej: 137 = 128+9 = SIGKILL) |
...
```bash
# ¿Cuál es el exit code de cada comando?
true; echo "true: $?"
false; echo "false: $?"
